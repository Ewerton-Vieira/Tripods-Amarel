...
#SBATCH --job-name=2_ack_MG # Job name
#SBATCH --output=2_ack_output_%N_%j.out     # STDOUT output file
#SBATCH --error=2_ack_output_%N_%j.err      # STDERR output file (optional)
...
srun python 2_hyb_ackermann.py
