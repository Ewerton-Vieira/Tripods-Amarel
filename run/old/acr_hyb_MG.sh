...
#SBATCH --job-name=Acr_hyb_MG # Job name
#SBATCH --output=Acr_hyb_MG%j.out     # STDOUT output file
#SBATCH --error=Acr_hyb_MG%j.err      # STDERR output file (optional)
...
srun python acrobot_hyb_RoA.py
