...
#SBATCH --job-name=Ack_lqr_MG # Job name
#SBATCH --output=Ack_lqr_MG%j.out     # STDOUT output file
#SBATCH --error=Ack_lqr_MG%j.err      # STDERR output file (optional)
