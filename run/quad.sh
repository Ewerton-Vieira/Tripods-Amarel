...
#SBATCH --job-name=Quad # Job name
#SBATCH --output=Quad%j.out     # STDOUT output file
#SBATCH --error=Quad%j.err      # STDERR output file (optional)
...
srun python compute_RoA.py examples/quadrotor_lqr_noise.txt
