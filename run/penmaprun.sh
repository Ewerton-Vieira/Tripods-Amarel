...
#SBATCH --job-name=Pend_map # Job name
#SBATCH --output=Pend_map_%N_%j.out     # STDOUT output file
#SBATCH --error=Pend_map_%N_%j.err      # STDERR output file (optional)
...
srun python pendulum_lc_map.py
